...
const AllocationForm = (props) => {
  ...
  return (
    <div className="flex my-2 border flex-col">
      {/* <div className="flex "> */}
        <h3 className="text-4xl font-semibold my-5 max-sm:text-xl">Change Allocation</h3>
      {/* </div> */}
        <div className="flex w-[80%] justify-between flex-wrap md:flex-col md:gap-4 max-md:gap-3 max-md:w-[60%]">
          <div className="ml-8 flex max-md:ml-0 h-10 md:ml-0">
            ...
            <select className="border w-48 bg-white border-slate-300 text-2xl pl-2 max-md:text-sm md:text-xl" name="" id="inputGroupSelect01" onChange={(e)=> setName(e.target.value)}>
              ...
              <option value="House Rent" className="">House Rent</option>
              <option value="Food" className="">Food</option>
              <option value="Hygiene Product" className="">Hygiene Product</option>
              <option value="Shopping" className="">Shopping</option>
              <option value="Transport" className="">Transport</option>
              <option value="Gift" className="">Gift</option>
              <option value="Miscellaneous" className="">Miscellaneous</option>
            </select>
          </div>
          ...
          <input className="border bg-white border-slate-300 text-2xl w-44 h-10 max-md:text-sm md:text-xl p-2" required='required' type='number' id="cost" value={cost} onChange={(e)=>setCost(e.target.value)} />
